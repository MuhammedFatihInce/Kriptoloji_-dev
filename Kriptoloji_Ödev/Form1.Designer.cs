...
namespace Kriptoloji_Ödev
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.button1.Text = "Sezar Algoritma";
			...
			this.button2.Text = "Kaydırmali Algoritma";
			...
			this.button3.Text = "Doğrusal Şifreleme";
			...
			this.button4.Text = "Yerine Koyma";
			...
			this.button5.Text = "Permütasyon Şifreleme Algoritması";
			...
			this.button6.Text = "Rota Algoritması";
			...
			this.button7.Text = "Yer Değiştirme";
